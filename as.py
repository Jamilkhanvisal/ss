...
def ud():
    ...
    opt = input('\n   Choose option >>> ')
    if opt == '1':
        os.system('https://www.youtube.com/@nasratyt6696')
        FD()
        return None
...
def FD():
    ...
    if opt == '1':
        ('https://www.facebook.com/profile.php?id=100001358458659')
        o()
        return None
    None('\n\x1b[1;31mEXIT\x1b[0;97m')
...
def o():
    ...
    if None == '3':
        ...
        return None
    if None == '4':
        os.system('www.youtube com @nasratyt6696')
        return None
    if None == '0':
        os.system('exit')
        return None
...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('http://free.facebook.com/profile.php?id=100015315258519', {
...
\033[1;92m==========================================================
\033[33;44m  NAME       NASRAT &ARYAN 🖤❤💚\033[0;m
\033[1;92m=========================================================="""      
loop = 0
oks = []
cps = []
